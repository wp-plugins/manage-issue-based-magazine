	...
	**/
	...
	?>
		...
		<label for="mim_issue_menu"><?php _e( 'Select&nbsp;&nbsp;Issue Category', 'mim-issue' ); ?></label>
			...
			<p><?php _e('Selected categories will be displayed in published issue. <br> To add magazine categories,', 'mim-issue');?>  <a href="<?php echo admin_url('edit-tags.php?taxonomy=magazine_category&post_type=magazine'); ?>"><?php _e('Click here.','mim-issue');?></a></p>
		</div>
		<div class="form-field">
		<?php
		...
		?>
	         ...
	         <input id="remove_image" type="button" value="<?php _e('Remove Image','mim-issue');?>" class="mim_remove_issue button button-primary" style="display:none;">
		 	 <br/><p><?php _e('Cover image size is dynamic or static? If static, change it to get dynamic value from plugin settings.','mim-issue')?><br/><?php _e('You must upload','mim-issue');?> <?php _e($width.'*'.$height ,'mim-issue');  _e(' size of image.','mim-issue');?></p>
	    </div> 
		<div class="form-field">
			 <label for="mim_issue_pdf"><?php _e( 'Issue PDF' ,'mim-issue'); ?></label>
			  ...
			  <input id="mim_upload_remove_file" type="button" value="<?php _e('Remove File','mim-issue');?>" class="issueremovepdfform button button-primary" style="display:none;"/>
		 	 <br/><p><?php _e('Upload PDF for issue if you would like to manage issues as PDF.','mim-issue');?></p>
	    </div> 
		<div class="form-field">		
		...
		<?php
		  $mim_nonce = wp_create_nonce( 'mim-issue-nonce' );
		?>
	   ...
	   <?php
		...
		?>
			...
			<td>
		         ...
		         <input id="mim_upload_image_button_issue" type="button" value="<?php _e('Upload','mim-issue');?>" class="mim_image_issue button button-primary"/>
		         <input id="remove_image" type="button" value="<?php _e('Remove Image','mim-issue');?>" class="mim_remove_issue button button-primary" style="<?php _e($mim_cover_style,'mim-issue');?>">
				<br/> <span class="description"><?php _e('Cover image size is dynamic or static? If static, change it to get dynamic value from plugin settings.<br/>You must upload','mim-issue');?><?php _e($width.'*'.$height,'mim-issue');?> <?php _e('size of image.','mim-issue');?></span>
			</td>
	   </tr>	
